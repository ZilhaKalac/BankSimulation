...
public BankSimulation (){
    ...
    public void run() {
        ...
        do {
            ...
            System.out.println("3. Müşteri işlemleri");
            ...
            switch (choice) {
                ...
                case 3:
                    ...
                    break;
                case 0:
                    System.out.println("Çıkıs yapılıor");
                    break;
                default:
                    System.out.println("Geçersiz seçim! Terkar deneyin.");
                    return;
            }
        } while (choice != 0);
    ...
    public void listCustomers() {
        ...
        for (Customer customer : customers.values()) {
            if(!customers.isEmpty()) {
                ...
                System.out.println("Henüz kaydedilmiş bir hesap yok");
            }
        }
    ...
    public void addCustomer() {
        ...
        Customer customer = new Customer(city, firstName, lastName);
    ...
    ///////////////////////////////////////////////////////////////////////////////////////////
        ...
        public void openNewAccount (Customer customer){
            ...
            AccountType accountType = null;
                ...
                System.out.println("Seçilmiş hesap turu: " + accountType);


                int accountId = accounts.size()+1;
                Account newAccount = new Account(accountId,customer.getCustomerId(), accountType);
        ...
        public void depositToAccount (Customer customer){
            ...
            int checkAccountId = scanner.nextInt();
            scanner.nextLine();

            Account account = getAccountById(checkAccountId);

            if(account == null|| account.getCustomerId() != customer.getCustomerId())
            {
                System.out.println("Geçersiz hesap numarası! Tekrar deneyin.");
            }else{
        ...
        public void withdrawToAccount (Customer customer) {
            ...
            if (account == null || account.getCustomerId() != customer.getCustomerId()) {
                ...
                System.out.print("Çekmek istediğiniz tutar girin: ");
                double amount = scanner.nextDouble();
